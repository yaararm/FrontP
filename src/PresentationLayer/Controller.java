        ...
        try {
            ...
            reg.setOnAction((event -> {
                ...
                if (first.getText()==null || first.getText().trim().isEmpty() || last.getText()==null || last.getText().trim().isEmpty()){
                    ...
                    String exception = myViewModel.signUp(first.getText(),last.getText(),email.getText(),password.getText());
                    if (exception.compareTo("fine")==0){
                        String userName =  myViewModel.getUserName(email.getText());
                        title.setText("Hi, " + userName+"!");
                        user_name_photo.setText(userName);
                        //switchTab(myViewModel.getUserInstance(email.getText()));
                        stage.close();
    ...
    public void show_Loginform(ActionEvent actionEvent) {
        ...
        try {
            ...
            log.setOnAction((event -> {
                ...
                if (!myViewModel.loginDetails(password,mail)){
                    invalid.setVisible(true);
                }
                else{
                    String userName =  myViewModel.getUserName(mail);
                    title.setText("Hi, " + userName+"!");
                    user_name_photo.setText(userName);
                    stage1.close();
                }
...
/*
    ...
    public void create_newTeam(ActionEvent actionEvent) throws Exception {
        ...
        if (myViewModel.creatNewTeam(team_name.getText())){
